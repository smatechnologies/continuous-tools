...
allowed-tools: Read Write Edit Glob Grep Agent Bash(git status:*) Bash(git diff:*) Bash(git checkout:*) Bash(git stash:*) Bash(poetry run pytest:*) Bash(poetry run mypy:*) Bash(poetry run ruff:*) Bash(pnpm test:*) Bash(pnpm lint:*) Bash(pnpm tsc:*)
---
